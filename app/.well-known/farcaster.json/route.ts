export async function GET() {
  return Response.json({
    "frame": {
      ...
      "subtitle": "Ubizo is a decentralized application that allows users to create a safety circle of trusted contacts and send SOS alerts in case of an emergency.",
